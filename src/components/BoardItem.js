    ...
    <React.Fragment>
      ...
      >
        ...
        <Container className="board-item_object">
          <p>
            <span className="board-item_defaults">Title:</span>{' '}
            {boardItem?.title}
          </p>{' '}
          <p>
            <span className="board-item_defaults">Assignee:</span>{' '}
            {boardItem?.assignee}
          </p>
          <p>
            <span className="board-item_defaults">Description:</span>{' '}
            {boardItem?.description}
          </p>
          <p>
            <span className="board-item_defaults">Status:</span>{' '}
            {boardItem.status &&
              statuses.find((status) => status.position === boardItem.status)
                ?.name}
          </p>
          <p>
            ...
            {boardItem.priority &&
              priorities.find(
                (priority) => priority.value === boardItem.priority
              )?.name}
          </p>
          <p>
